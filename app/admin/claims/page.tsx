  ...
  return (
    <main id="main" className="mx-auto max-w-4xl px-5 py-12">
      ...
      <p className="mt-3 text-muted">
        Verify ownership using independently sourced restaurant contact details. A matching name or
        submitted evidence alone is not proof. Decisions and verification notes are recorded; review
        notes are visible to the owner.
      </p>
      {params.saved && (
      ...
      <div className="mt-6 flex gap-3">
        {page > 0 && <ButtonLink href={`/admin/claims?page=${page - 1}`}>Previous page</ButtonLink>}
        {claims.length === 50 && (
